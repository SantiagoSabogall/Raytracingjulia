...
# IMPORTANTE: Importamos explícitamente las funciones base desde el módulo principal
...
# Extendemos la función Omega para Kerr
...
# Extendemos la métrica para Kerr
function metric(b::KerrBH, x::Vector{<:Real})
    r2 = x[2]*x[2]
    a2 = b.a*b.a
...
# Extendemos la métrica inversa para Kerr
function inverse_metric(b::KerrBH, x::Vector{<:Real})
    r2 = x[2]*x[2]
    a2 = b.a*b.a
    sin_theta2 = sin(x[3])^2
    Delta = r2 - 2*x[2] + a2
...
# Extendemos las geodésicas (asegurando el orden u, p, t)
